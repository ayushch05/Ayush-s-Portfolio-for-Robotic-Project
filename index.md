...
|:--:|:--:|:--:|:--:|
| Chassis, and TT Motors, TT Wheels Kit | Contains two motors for each one to be connected to each wheel and a chassis (acrylic plate)  | $9.09 | <a href="[https://www.amazon.com/Wishiot-2pcs-DC3-6V-Motor-Reduction/dp/B07VBXXT9M/ref=sr_1_14?keywords=TT+wheel&qid=1687547293&sr=8-14](https://www.amazon.com/Ardokit-Chassis-Encoder-Battery-Arduino/dp/B00K5OWHXO/ref=sr_1_32?crid=1XXQOORADTDRZ&keywords=acrylic+plate+arduino+car&qid=1687549054&sprefix=acrylic+plate+arduino+car%2Caps%2C130&sr=8-32)"> Link </a> |
|:--:|:--:|:--:|:--:|
